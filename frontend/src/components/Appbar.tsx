...
export function Appbar() {
    ...
    return <div  className="border-b flex justify-between px-4 sm:px-10 py-4">
        ...
        <div className="flex ml-4 sm:ml-0">
            <div className="mr-5">
                <form className="flex items-center lg:max-w-sm mx-auto">   
      ...
      {isOpen && (
        <div id="dropdown" className="z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-28 dark:bg-gray-700">
          <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
            <li>
              <Link to="/publish" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
