  ...
  return (
    <div className="min-h-screen flex flex-col bg-amber-50">
        ...
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <Link to={"/home"} className="pt-2 md:flex md:flex-col md:justify-center">
    ...
    >
      ...
      <motion.div 
        ...
        variants={itemVariants}
      >
        <p className='text-right'>Last updated: 31 December 2024</p>
        <h2 className='text-2xl m-2'>1. Introduction</h2>
        <p>Welcome to Medium ("we," "our," or "us"). We are committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.</p>
        
        <h2 className='text-2xl m-2'>2. Information We Collect</h2>
        <p>We collect information that you provide directly to us, such as when you create an account, publish content, or contact us for support. This may include:</p>
        <ul>
        ...
        <h2 className='text-2xl m-2' >3. How We Use Your Information</h2>
        ...
        <h2 className='text-2xl m-2'>4. Sharing of Information</h2>
        <p>We may share your information with:</p>
        <ul>
          <li>Service providers who perform services on our behalf</li>
          <li>Other users, when you publish content</li>
          <li>Legal authorities, when required by law</li>
        </ul>
        
        <h2 className='text-2xl m-2'>5. Your Rights and Choices</h2>
        ...
        <h2 className='text-2xl m-2'>6. Security</h2>
        ...
        <h2 className='text-2xl m-2'>7. Changes to This Policy</h2>
        <p>We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page.</p>
        
        <h2 className='text-2xl m-2'>8. Contact Us</h2>
        <p>If you have any questions about this Privacy Policy, please contact us at:</p>
        <p>Email: privacy@medium.com</p>
        <p>Address: 123 Medium Street, San Francisco, CA 94107</p>
      </motion.div>
      <motion.div 
