    ...
    <div className="min-h-screen flex flex-col bg-amber-50">
      ...
      <main className="flex-1">
        <div className="flex justify-between">
          <div className="w-full lg:w-1/2 pr-0 md:pr-12 py-20 md:py-32 px-10 md:px-20">
            <h1 className="text-[85px] leading-[84px] tracking-tight font-serif mb-8">
              Human stories & ideas
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-xl">
          ...
          <div className="hidden lg:flex lg:justify-end md:w-1/2">
            <img
                src="/home.webp"
                alt="Decorative geometric pattern"
                className="h-[600px] w-[460px] hidden lg:block"
            />
          </div>
        </div>
      </main>
      ...
      <footer className="border-t py-8">
        <div className="container mx-auto px-4">
          <nav className="flex flex-wrap gap-x-6 gap-y-4">
            ...
            <a href="/status" className="text-sm text-gray-600 hover:text-gray-900">Status</a>
            <a href="/about" className="text-sm text-gray-600 hover:text-gray-900">About</a>
            <a href="/careers" className="text-sm text-gray-600 hover:text-gray-900">Careers</a>
            <a href="/press" className="text-sm text-gray-600 hover:text-gray-900">Press</a>
            ...
            <a href="/text-to-speech" className="text-sm text-gray-600 hover:text-gray-900">Text to speech</a>
            <a href="/teams" className="text-sm text-gray-600 hover:text-gray-900">Teams</a>
          </nav>
        </div>
      </footer>
    </div>
